...
function questionnaire_get_type ($id) {
	...
	case 12:
        	return get_string('database', 'questionnaire');
        case 100:
...
//private 
function make_key($type,$fieldid,$rowid) {
//$val = optional_param('q'. $suf.$this->id.'-'. $nresult->id.'-'.$i, null, PARAM_CLEAN);
     $survqid = suffix($type).'100';
    $mykey = "q${survqid}-$fieldid-$rowid";
return $mykey;
 }
