...
$string['database_help'] = 'Database linked to here';
$string['databaseid_help'] = 'Database Id entered to here';
$string['databaseid'] = 'Database ID';
$string['Database'] = 'Database';
$string['databases'] = 'Database';
$string['databases_help'] = 'Database linked to here';
$string['dbase_help'] = 'Use this question type to link to a database in the data module.';
$string['noofrows'] = 'Database rows to expose';
$string['noofrows_help'] = 'Database rows to expose';
$string['date'] = 'Date';
